...
"""
GNSS-Based Earthquake Displacement Visualizer
============================================
Visualizing Coseismic Displacement Signatures in East African GNSS Time Series

JKUAT — Department of Geomatic Engineering and Geospatial Information Systems
Geodesy Project
...
2. Run the app:
   streamlit run gnss_earthquake_app.py

3. A browser window will open automatically at http://localhost:8501
   No internet connection required. All data is built into this file.
"""
...
st.markdown('<div class="sub-title">Visualizing Coseismic Displacement Signatures in East African GNSS Time Series &nbsp;|&nbsp; JKUAT Geodesy Project</div>', unsafe_allow_html=True)
